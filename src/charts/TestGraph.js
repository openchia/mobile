  ...
  return (
    ...
    >
      <ScrollView style={{ backgroundColor: 'black' }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <TouchableOpacity onPress={() => setSmoothingWhileTransitioningEnabled(true)}>
            <Text
              style={{
                color: smoothingWhileTransitioningEnabled ? 'lightgreen' : 'white',
              }}
            >
              Yes
            </Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setSmoothingWhileTransitioningEnabled(false)}>
            <Text
              style={{
                color: !smoothingWhileTransitioningEnabled ? 'lightgreen' : 'white',
              }}
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <TouchableOpacity onPress={() => setDataSource(1)}>
            <Text style={{ color: dataSource === 1 ? 'lightgreen' : 'white' }}>Data 1</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setDataSource(2)}>
            <Text style={{ color: dataSource === 2 ? 'lightgreen' : 'white' }}>Data 2</Text>
          </TouchableOpacity>
        </View>
        <Text style={{ color: 'white', fontWeight: 'bold' }}>Simplifying:</Text>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <TouchableOpacity onPress={() => setSimplifying(true)}>
            <Text style={{ color: simplifying ? 'lightgreen' : 'white' }}>Yes</Text>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setSimplifying(false)}>
            <Text style={{ color: !simplifying ? 'lightgreen' : 'white' }}>No</Text>
          </TouchableOpacity>
        </View>
        {simplifying ? (
          <>
            <Text style={{ color: 'white', fontStyle: 'italic' }}>Pick range:</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              <TouchableOpacity onPress={() => setPickRange(2)}>
                <Text style={{ color: pickRange === 2 ? 'lightgreen' : 'white' }}>2</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setPickRange(5)}>
                <Text style={{ color: pickRange === 5 ? 'lightgreen' : 'white' }}>5</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setPickRange(10)}>
                <Text style={{ color: pickRange === 10 ? 'lightgreen' : 'white' }}>10</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setPickRange(25)}>
                <Text style={{ color: pickRange === 25 ? 'lightgreen' : 'white' }}>25</Text>
              </TouchableOpacity>
            </View>
            <Text style={{ color: 'white', fontStyle: 'italic' }}>Include extremes:</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              <TouchableOpacity onPress={() => setIncludeExtremes(true)}>
                <Text style={{ color: includeExtremes ? 'lightgreen' : 'white' }}>Yes</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setIncludeExtremes(false)}>
                <Text style={{ color: !includeExtremes ? 'lightgreen' : 'white' }}>No</Text>
              </TouchableOpacity>
            </View>
          </>
        ) : null}
        <Text style={{ color: 'white', fontWeight: 'bold' }}>Interpolation strategy:</Text>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
          <TouchableOpacity onPress={() => setInterpolationStrategy('none')}>
            <Text
              style={{
                color: interpolationStrategy === 'none' ? 'lightgreen' : 'white',
              }}
            >
              None
            </Text>
          ...
          <TouchableOpacity onPress={() => setInterpolationStrategy('mono')}>
            <Text
              style={{
                color: interpolationStrategy === 'mono' ? 'lightgreen' : 'white',
              }}
            >
        ...
        {interpolationStrategy === 'b' ? (
          <>
            <Text style={{ color: 'white', fontStyle: 'italic' }}>BSpline degree:</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
        ...
        {interpolationStrategy !== 'none' ? (
          <>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              <TouchableOpacity onPress={() => setNumberOfPointsInterpolated(30)}>
                <Text
                  style={{
                    color: numberOfPointsInterpolated === 30 ? 'lightgreen' : 'white',
                  }}
                >
                  30
                </Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setNumberOfPointsInterpolated(80)}>
                <Text
                  style={{
                    color: numberOfPointsInterpolated === 80 ? 'lightgreen' : 'white',
                  }}
                >
                  80
                </Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setNumberOfPointsInterpolated(120)}>
                <Text
                  style={{
                    color: numberOfPointsInterpolated === 120 ? 'lightgreen' : 'white',
                  }}
                >
                  120
                </Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setNumberOfPointsInterpolated(200)}>
                <Text
                  style={{
                    color: numberOfPointsInterpolated === 200 ? 'lightgreen' : 'white',
                  }}
                >
                  200
                </Text>
        ...
        <Text style={{ color: 'white', fontWeight: 'bold' }}>Smoothing strategy:</Text>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
        ...
        {smoothingStrategy !== 'none' && smoothingStrategy !== 'bezier' ? (
          <>
            <Text style={{ color: 'white', fontStyle: 'italic' }}>Smoothing factor:</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
