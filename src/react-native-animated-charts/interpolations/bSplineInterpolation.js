...
class BSpline {
  ...
  basisDeg4(x) {
    ...
    if (x >= 1.5 && x <= 2.5) {
      return (
        625.0 / 384.0 + x * (-(125.0 / 48.0) + x * (25.0 / 16.0 + (-(5.0 / 12.0) + x / 24.0) * x))
      );
    }
    if (x >= -2.5 && x <= -1.5) {
  ...
  basisDeg5(x) {
    if (x >= -2 && x < -1) {
      return (
        17.0 / 40.0 +
        x * (-(5.0 / 8.0) + x * (-(7.0 / 4.0) + x * (-(5.0 / 4.0) + (-(3.0 / 8.0) - x / 24.0) * x)))
      );
    }
    if (x >= 0 && x < 1) {
    ...
    if (x >= 2 && x <= 3) {
      return (
        81.0 / 40.0 +
        x * (-(27.0 / 8.0) + x * (9.0 / 4.0 + x * (-(3.0 / 4.0) + (1.0 / 8.0 - x / 120.0) * x)))
      );
    }
    if (x >= -3 && x < -2) {
      return (
  ...
  calcAt(t) {
    t *= (this.degree + 1) * 2 + this.points.length; // t must be in [0,1]
    if (this.dimension === 2) {
